...
const imgListDir = `${publishDir}/img_list`
...
// Procesar los archivos JSON dentro de ${publishDir}/img_list
if (fs.existsSync(imgListDir)) {
  const jsonFiles = fs.readdirSync(imgListDir)

  Promise.all(
    jsonFiles.map(async (file) => {
      const filePath = path.join(imgListDir, file)
